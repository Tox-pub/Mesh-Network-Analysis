...
Original file is located at
    https://colab.research.google.com/drive/11RtGDLSDd0crSpevIw3iUlCAPK7SmMJd
"""

"""
cli.py

Primary orchestrator for the MeSH AOP Network package.
Executes the pipeline sequentially or by specific modules using argparse.

Usage:
    mesh-pipeline --step all
    mesh-pipeline --step process --interactive
    mesh-pipeline --step viz
    mesh-pipeline --step secondary --interactive
"""
