# -*- coding: utf-8 -*-
"""mesh_data_processor.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vUb35hw0q4Difs30X9BxHG_P4nda4mh2
"""

"""
mesh_data_processor.py

A utility module to process raw MeSH XML data from the NLM.
1. Parses the MeSH XML file in a single, memory-efficient pass.
2. Extracts unique MeSH Terms, UIs, and Tree Numbers.
3. Generates a stop words python file by filtering terms based on hierarchies.
4. Tags the extracted CSV with a boolean flag indicating if a term is a stop word.
"""
