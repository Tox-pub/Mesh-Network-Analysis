...
Generated by extracting Tree Numbers from MeSH XML file.
"""
...
MESH_STOP_WORDS = [
    ...
    #   2. Terms for which categories could not be determined.
    ...
    #---------------------------------------------------------------------------
    # Terms With Undetermined Categories (No valid Tree Numbers found)
